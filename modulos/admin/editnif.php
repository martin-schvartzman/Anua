...
<?php
if($_SESSION["usuario"]>0 && isset($_POST["editnif"]) && (
privilegioscheckedit($_SESSION["usuario"],getnifcategoria($_POST["editnif"])) 
|| getnifautor($_POST["editnif"])==$_SESSION["usuario"] 
)){

if(privilegioscheckedit($_SESSION["usuario"],getnifcategoria($_POST["editnif"])) 
|| getnifautor($_POST["editnif"])==$_SESSION["usuario"] || isadmin($_SESSION["usuario"])){

$_SESSION["nif"]=$_POST["editnif"];
addnifestado($_SESSION["nif"],0);
...
$(document).ready(function(){
	...
	$("#nifcategoria .boxcontent .edit").click(function(){
		$("#nifcategoria .boxcontent").html("Cargando...");
	...
	$("#niftitulo .boxcontent .edit").click(function(){
		$("#niftitulo .boxcontent").html("Cargando...");
	...
	$("#nifcontenido .boxcontent .edit").click(function(){
		$("#nifcontenido .boxcontent").html("Cargando...");
	...
	$("#nifgaleria .boxcontent .edit").click(function(){
		$("#nifgaleria .boxcontent").html("Cargando...");
	...
	$("#niffoto .boxcontent .edit").click(function(){
		$("#niffoto .boxcontent").html("Cargando...");
	...
	$("#nifvideo .boxcontent .edit").click(function(){
		$("#nifvideo .boxcontent").html("Cargando...");
	...
	$("#nifaudio .boxcontent .edit").click(function(){
		$("#nifaudio .boxcontent").html("Cargando...");
