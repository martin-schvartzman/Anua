...
$(document).ready(function (){
	$(".header button.edit").click(function(){
		...
		$("#content" + $(this).attr("cod")).load("./modulos/admin/editusuario.php",{editid:$(this).attr("cod")});
	});
	$(".header button.del").click(function(){
		$("#cont").html("Cargando consulta");
		$("#cont").load("./modulos/admin/delusuario.php",{id:$(this).attr("cod")});
	});
...
<br/>
<button class="add" id="addusuario">
Nuevo Usuario
</button>
<?php
$usrs=getusuarios();
...
?>
<div class="box">
	<div class="header"><?php echo $u["user"]; ?>
