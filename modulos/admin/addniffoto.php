...
<tr>
	...
	<td>W:</td>
	<td><input type="text" style="width:75px" value="140" id="nif_foto_w"/>px</td>
	<td></td>
</tr>
<tr>
	<td>H:</td>
	<td><input type="text" style="width:75px" value="140" id="nif_foto_h"/>px</td>
	<td></td>
</tr>
<tr>
	<td colspan="3" rowspan="2">Texto<br/>
	<textarea id="nif_foto_texto" style="width:300px;height:150px;"></textarea>
	</td>
</tr>
<tr>
	<td>Enlace:</td>
	<td><input type="text" style="width:300px" id="nif_foto_link"/></td>
</tr>
<tr><td><button id="addniffoto">Enviar</button></td><td></td><td></td><td></td><td></td></tr>
</table>
<?php
}
