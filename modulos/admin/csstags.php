...
$(document).ready(function (){
	$(".header button.edit").click(function(){
		...
		$("#content" + $(this).attr("cod")).load("./modulos/admin/editcsstag.php",{editid:$(this).attr("cod")});
	});
	$(".header button.del").click(function(){
		$("#cont").html("Cargando consulta");
		$("#cont").load("./modulos/admin/delcsstag.php",{id:$(this).attr("cod")});
	});
